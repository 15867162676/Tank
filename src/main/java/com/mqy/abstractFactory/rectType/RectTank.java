...
public class RectTank extends BaseTank {
    ...
    //设置坦克的大小--获取图片大小
    public static int WIDTH = ResourceMgr.rectTanks[0].getWidth();
    public static int HEIGHT = ResourceMgr.rectTanks[0].getHeight();
    ...
    private void getGoodTankImage(int index,Graphics graphics){
        BufferedImage bufferedImage = null;
        bufferedImage = ResourceMgr.rectTanks[index];
